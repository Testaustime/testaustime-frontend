...
export const calculateTickValues = (maxDurationSeconds: number) => {
  ...
  if (maxDurationSeconds <= 3600) {
    return Array(Math.ceil(maxDurationSeconds / 600) + 1)
      .fill(0)
      .map((_, idx) => idx * 600);
  }
  ...
  if (maxDurationSeconds <= 10800) {
    return Array(Math.ceil(maxDurationSeconds / 1800) + 1)
      .fill(0)
      .map((_, idx) => idx * 1800);
  }
  ...
  if (maxDurationSeconds <= 21600) {
    return Array(Math.ceil(maxDurationSeconds / 3600) + 1)
      .fill(0)
      .map((_, idx) => idx * 3600);
  }
  ...
  if (maxDurationSeconds <= 43200) {
    return Array(Math.ceil(maxDurationSeconds / 7200) + 1)
      .fill(0)
      .map((_, idx) => idx * 7200);
  }
  ...
  if (maxDurationSeconds <= 86400) {
    return Array(Math.ceil(maxDurationSeconds / 14400) + 1)
      .fill(0)
      .map((_, idx) => idx * 14400);
  }
  ...
  if (maxDurationSeconds <= 180000) {
    return Array(Math.ceil(maxDurationSeconds / 28800) + 1)
      .fill(0)
      .map((_, idx) => idx * 28800);
  }
  ...
  if (maxDurationSeconds <= 360000) {
    return Array(Math.ceil(maxDurationSeconds / 54000) + 1)
      .fill(0)
      .map((_, idx) => idx * 54000);
  }
